    ...
    <div x-data="{ open: false }">
        ...
        <div x-show="open" @click.away="open = false"
            ...
            <div class="fixed top-0 w-10/12 font-bold bg-primary text-white p-2 z-20">
                ...
                @guest
                    <a href="{{ route('login') }}" class="block text-menu-link hover:bg-transparent hover:text-white">
                        {{ __('messages.Login') }}
                    </a>
                    <a href="{{ route('register') }}" class="block text-menu-link hover:bg-transparent hover:text-white">
