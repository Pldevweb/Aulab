...
@section('content')
    <div class="container mx-auto px-4 py-8">
        ...
        @if ($message = Session::get('success'))
            <div id="success-alert" class="bg-button hover:bg-[#727262] text-white  flex items-center rounded relative mb-4"
                role="alert">
                            ...
                            <div class="mt-4 flex items-center">
                                ...
                                <div class="flex items-center">
                                    ...
                                    <span class="mx-2 text-gray-600">
                                        <input type="number" id="quantity{{ $cartProduct->id }}" name="quantity" disabled
