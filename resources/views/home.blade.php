...
@section('content')
    <div class="flex items-center bg-white flex-col w-4/6 m-3">
        <div class="w-5/6 h-5/6 mt-4 bg-cover bg-center"
            style="background-image: url('{{ asset('storage/images/accueilimg.jpg') }}');">
        ...
        <div class="mt-4 grid grid-cols-[6fr,1fr] w-5/6 h-1/2 gap-4">
            ...
            <div class="flex flex-col justify-between h-full">
                <img src="https://www.akc.org/wp-content/uploads/2021/07/Cavalier-King-Charles-Spaniel-laying-down-indoors.jpeg"
                    class="h-96 w-48 object-cover" />
