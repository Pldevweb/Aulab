...
<!-- web -->
            <section class="hidden lg:block lg:w-5/6 lg:h-auto lg:mt-5 lg:bg-cover lg:bg-center lg:bg-accueil">
                <div class="flex justify-end my-20">
                    <div class="bg-[#626262] bg-opacity-30 shadow-[0px_0px_5px_#383838] w-1/3 h-5/6 rounded p-4 m-2 drop-shadow-[1px_1px_0px_#6c6c5b]">
    ...
    <!-- SECTION 5 -->
        <section class="mt-5 mb-5 lg:grid lg:grid-cols-[1fr,1fr] w-5/6 h-1/2 lg:gap-4">
            <div class="flex flex-col h-full justify-center items-center">
                ...
                <button class="hidden lg:block lg:border lg:border-[#5e5e4a] lg:w-36 lg:hover:bg-[#e3e3d2] lg:text-gray-800 lg:p-3 lg:m-10">
                    <a href="{{ route('produits-pour-chiens.index') }}" class="text-xs text-main-color">
        ...
        <section>
            ...
            <div class="grid lg:grid-cols-3 gap-5 px-10 lg:px-52 py-5">
                <div class="text-main-color text-justify">
                    <div class="flex justify-center"><img src="{{ asset('storage\images\chien.png') }}" class="w-40 h-40 object-cover mb-5 rounded-full"/></div>
                ...
                <div class="text-main-color text-justify">
                    <div class="flex justify-center"><img src="{{ asset('storage\images\chien2.png') }}" class="w-40 h-40 object-cover mb-5 rounded-full"/></div>
                ...
                <div class="text-main-color text-justify">
                    <div class="flex justify-center"><img src="{{ asset('storage\images\chien3.png') }}" class="w-40 h-40 object-cover mb-5 rounded-full"/></div>
