    ...
    <div class="container my-24 mx-auto md:px-6">
        <section class="mb-32 text-center">
            <div class="mx-auto max-w-[700px] md:px-3">
                <h1 class="text-3xl text-main-color mb-16 uppercase">{{ __('messages.Contactez_nous') }}</h1>
                <form>
